...
class iCaRL(BaseLearner):
    ...
    def _train(self, train_loader, test_loader):
        ...
        if self._cur_task == 0:
            ...
            scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer=optimizer, T_max=self.init_epoch, eta_min=1e-5)
            ...
            scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer=optimizer, T_max=self.epochs, eta_min=1e-5)
